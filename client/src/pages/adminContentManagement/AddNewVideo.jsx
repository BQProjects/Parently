                ...
                <div className='border-1 border-gray-300 w-[70%] rounded-lg'>
                    ...
                    <div className="mb-6 px-6 pb-4">
                        ...
                        <div
                            ...
                            className={`border-2 border-dashed rounded-lg p-12 text-center cursor-pointer transition-colors ${drag ? 'border-green-500 bg-green-50' : 'border-gray-300 bg-gray-50 hover:border-gray-400'
                                }`}
                        >
                            <input
                                ref={fileInputRef}
