...
const Sidebar = () => {
  return (
    <>
      <div className="min-h-screen flex flex-col bg-[#FFFBF4]">
        <Header />

        <div className="flex flex-1 overflow-hidden">
          {/*Side Bar Layout */}
          <div className="w-60 bg-[#FFFBF4] border-r-2 border-gray-300 p-4 space-y-4 flex flex-col">
            <NavLink
              to="/admin/dashboard"
              className={({ isActive }) =>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {/* Secondary Navbar */}
            <div className="h-14 bg-[#FFFBF4] px-6 flex justify-end items-center space-x-6">
